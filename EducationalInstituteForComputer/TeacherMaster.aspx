<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TeacherMaster.aspx.cs" Inherits="EducationalInstituteForComputer.TeacherMaster" %>
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li>
                    <a runat="server" href="~/CourseMaster">Add Teachers</a>
                </li>
            </ul>
        </div>
        <div class="row">
