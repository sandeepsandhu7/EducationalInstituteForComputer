<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateStudentMaster.aspx.cs" Inherits="EducationalInstituteForComputer.UpdateStudentMaster" %>
    ...
    <div id="content" class="col-lg-10 col-sm-10">
        ...
        <div>
            <ul class="breadcrumb">
                ...
                <li>
                    <a runat="server" href="~/UpdateStudentMaster">Update Students</a>
                </li>
            </ul>
        </div>
        <div class="row">
                ...
                <div class="box-inner">
                    ...
                    <div class="box-content">
                        <div class="form-group">
                            <asp:DropDownList ID="ddl_Student" Style="margin-left: auto; margin-right: auto; text-align: center;" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="ddl_Student_SelectedIndexChanged">
                            </asp:DropDownList>
                        </div>
                        <div class="form-group">
