<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="EducationalInstituteForComputer._Default" %>
                ...
                <div class="box-inner">
                    ...
                    <div class="box-content row">
                        <div class="col-lg-7 col-md-12">
                            ...
                            <p>
                                It's a live demo of the template. I have created Charisma to ease the repeat work I have to do on my
                    ...
                    <div class="box-content">
                        ...
                        <div id="myTabContent" class="tab-content">
                            <div class="tab-pane active" id="info">
                                ...
                                <p>
                                    It's a full featured, responsive template for your admin panel. It's optimized for tablets
                            and mobile phones.
                                </p>
            ...
            <div class="box col-md-4">
                <div class="box-inner homepage-box">
                    ...
                    <div class="box-content">
                        ...
                        <p>
                            You may like my other open source work, check my profile on <a href="http://github.com/usmanhalalit"
